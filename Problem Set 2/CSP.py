...
# This is the type definition for an Assignment. Basically, an assignment is a dictionary where each key-value pair
# represents a variable and its assigned value respectively. If a variable is missing from an assignment, then its is
# still unassigned.
Assignment = Dict[str, Any]


# This is the base class for all the constraints
...
class UnaryConstraint(Constraint):
    ...
    condition: Callable[[
        Any], bool]  # A function that takes the variable's value and returns whether it satisfies the constraint or not.
...
class BinaryConstraint(Constraint):
    ...
    condition: Callable[[Any,
                         Any], bool]  # A function that takes the variables' values and returns whether they satisfy the constraint or not.
    ...
    # Given the name of a variable in the constraint, this function returns the other variable. For example,
    # if the constraint contains the variables A & B, this function will return A if given B, and will return B if
    # given A. Important: This function only works correctly if the given variable is in the constraint.
